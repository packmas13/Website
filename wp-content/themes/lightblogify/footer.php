		...
		<div class="site-info">
			&copy;<?php echo date('Y'); ?> <?php bloginfo( 'name' ); ?>
				...
				<span class="footer-info-right">
					<?php echo __(' | WordPress Theme by', 'lightblogify') ?> <a rel="nofollow" href="<?php echo esc_url('https://superbthemes.com/', 'lightblogify'); ?>"><?php echo __(' Superbthemes.com', 'lightblogify') ?></a>
				</span>
