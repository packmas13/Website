 ...
 */
function lightblogify_customize_register( $wp_customize ) {
	$wp_customize->get_setting( 'blogname' )->transport         = 'postMessage';
	$wp_customize->get_setting( 'blogdescription' )->transport  = 'postMessage';
	$wp_customize->get_setting( 'header_textcolor' )->transport = 'postMessage';
	$wp_customize->get_section('header_image')->title = __( 'Header Settings', 'lightblogify' );
	$wp_customize->get_section('colors')->title = __( 'Background Color', 'lightblogify' );

	if ( isset( $wp_customize->selective_refresh ) ) {
		$wp_customize->selective_refresh->add_partial( 'blogname', array(
			'selector'        => '.site-title a',
			'render_callback' => 'lightblogify_customize_partial_blogname',
			) );
		$wp_customize->selective_refresh->add_partial( 'blogdescription', array(
			'selector'        => '.site-description',
			'render_callback' => 'lightblogify_customize_partial_blogdescription',
			) );
	}

}
add_action( 'customize_register', 'lightblogify_customize_register' );




if(! function_exists('lightblogify_customizer_css_final_output' ) ):
	function lightblogify_customizer_css_final_output(){
		?>
		...
		<?php }
		add_action( 'wp_head', 'lightblogify_customizer_css_final_output' );
		endif;
 ...
 * @return void
 */
function lightblogify_customize_partial_blogname() {
	bloginfo( 'name' );
}
 ...
 * @return void
 */
function lightblogify_customize_partial_blogdescription() {
 ...
 */
function lightblogify_customize_preview_js() {
	wp_enqueue_script( 'lightblogify-customizer', get_template_directory_uri() . '/js/customizer.js', array( 'customize-preview' ), '20151215', true );
}
add_action( 'customize_preview_init', 'lightblogify_customize_preview_js' );
